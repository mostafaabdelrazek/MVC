...
<form method="POST" autocomplete="off" >
  <div class="container">
    ...
    <input type="numbe" placeholder="tax" name="tax" required>
    <hr>

    <button type="submit" class="registerbtn" name="submit"><?=$text_employee_register?></button>
  </div>
</form>
